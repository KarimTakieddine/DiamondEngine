...
{
	/* static */ SoundMetadataList AudioMetadataParser::parse(const std::string& file)
	{
	...
	/* static */ SoundMetadataList AudioMetadataParser::parse(const pugi::xml_document& document)
	{
		SoundMetadataList result;
	...
	/* static */ SoundMetadata AudioMetadataParser::parse(const pugi::xml_node& node)
	{
